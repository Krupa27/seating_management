...
//    List<Room> getRoomsBySize(int size);
...
//    
//    List<RoomCategorySummary> getRoomCategorySummaries(String location, String building);
//    
//    
//    List<Room> getRoomsByLocationBuildingAndType(String location, String building, String roomType);
